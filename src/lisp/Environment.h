...
namespace lisp
{
	...
	public:
		...
		CRAFT_LISP_EXPORTED instance<> parse_read(instance<SScope> scope, instance<Sexpr> ast);
		CRAFT_LISP_EXPORTED instance<> parse_eval(instance<SScope> scope, instance<Sexpr> ast);
		...
		// Interpreter Access
		CRAFT_LISP_EXPORTED instance<> eval(std::string const& text);
		CRAFT_LISP_EXPORTED instance<> eval(instance<> code);
