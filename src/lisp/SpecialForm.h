...
namespace lisp
{
	...
	*/
	...
	public:
		typedef std::function<instance<>(instance<Scope> scope, instance<Sexpr> sexpr)> f_eval;
	...
	public:
		...
		CRAFT_LISP_EXPORTED instance<> eval(instance<Scope> scope, instance<Sexpr> sexpr);
	};
