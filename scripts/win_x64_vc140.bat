...
REM Building Debug
msbuild CraftConsole.sln /t:Build /p:Configuration=Debug /property:Platform=x64 /property:PlatformToolset=v140 > build_debug.txt 2>&1
if NOT %ERRORLEVEL% EQU 0 (
...
msbuild CraftConsole.sln /t:Build /p:Configuration=Release /property:Platform=x64 /property:PlatformToolset=v140 > build_release.txt 2>&1
if NOT %ERRORLEVEL% EQU 0 (
  SET BUILD_DEBUG_STATUS=1
  GOTO fail
)
...
REM Running Tests
Debug\CraftConsoleTests > test_debug.txt 2>&1
if NOT %ERRORLEVEL% EQU 0 (
...
Release\CraftConsoleTests > test_release.txt 2>&1
if NOT %ERRORLEVEL% EQU 0 (
